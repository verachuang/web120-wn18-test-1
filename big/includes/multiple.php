...
#EDIT THE FOLLOWING:
$toAddress = "vera.weiting@gmail.com";  //place your/your client's email address here
$toName = "Vera Chuang"; //place your client's name here
...
if ($response != null && $response->success)
    ...
    <div class="contact-feedback">
        <h2>Thanks for your interest in our web severice.</h2>
       <p>We'll respond via email within 2 days, if you requested information.</p>
    </div>    
    <!-- END HTML FEEDBACK -->        
    <?php
